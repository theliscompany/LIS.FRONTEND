...
export const postApiRequestNew = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<PostApiRequestNewData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiRequestNewResponse, PostApiRequestNewError, ThrowOnError>({
        ...options,
        url: '/api/Request/new'
    });
};

export const getApiRequest = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
