...
function Layout(props: {children?: React.ReactNode}) {
  ...
  useEffect(() => {
    fetch("https://random-data-api.com/api/address/random_address?size=6")
  ...
  return (
    <React.Fragment>
      <Box sx={{ display: 'flex' }}>
            ...
            <Toolbar disableGutters>
                ...
                <Box sx={{ flexGrow: 0 }}>
                                    ...
                                    notifications.map((item: any, i: any) => {
                                        return (
                                            <MenuItem dense key={"msg-"+i} title="View" onClick={handleCloseNotificationsMenu}>
                                                ...
                                                <ListItemText primary={<Typography variant="subtitle2" noWrap={true}>{"New request from " + item.country}</Typography>} />
                                            </MenuItem>)
                                    })
                                }
                            </Menu>
                    ...
                    >
                        ...
                        <Divider />
                        <MenuItem dense key={"x1-Logout"} title="Logout" onClick={handleCloseUserMenu}>
                            <ListItemIcon className="cs-listitemicon">
        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3, background: "#f9fafb", height: "calc(100vh)" }}>
          <Toolbar />
          <Outlet />
        </Box>
      </Box>
