export const fr = {
  ...
  requestWizard: {
    ...
    step2: {
      ...
      incoterm: "Incoterm",
      comment: "Commentaire",
      availableServicesTitle: "Services fréquemment utilisés",
    ...
    step4: {
      ...
      subtitle: "Choisissez un transporteur pour votre demande.",
      filterCity: "Ville",
      filterPort: "Port",
      ...
      details: "Détails",
      close: "Fermer",
      selectThisOffer: "Sélectionner cette offre",
      selectedSeafreights: "Seafreights sélectionnés",
      requestSent: "Votre demande a été envoyée !",
      basket: "Panier",
      offerId: "ID de l'offre : {id}"
    },
    step5: {
      title: "Sélection des offres maritimes",
      subtitle: "Choisissez les offres maritimes pour votre demande.",
      ...
      select: "Sélectionner",
      deselect: "Désélectionner",
      baseFreightLabel: "Fret de base",
      totalLabel: "Total",
      validUntil: "Valide jusqu'au",
      transitLabel: "Transit (jours)",
      frequencyLabel: "Fréquence",
      quantity: "Quantité",
      searchSeafreightPlaceholder: "Rechercher une offre maritime...",
      totalTEU: "Total TEU sélectionné",
      selectedContainers: "Containers sélectionnés",
      details: "Détails",
      close: "Fermer",
      selectThisOffer: "Sélectionner cette offre"
    },
  ...
  noOptionsAvailable: "Aucune option disponible pour l'édition",
  switchToEditMode: "Passer en mode édition",
  switchToViewMode: "Passer en mode vue",
