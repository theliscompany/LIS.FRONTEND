export const en = {
  ...
  requestWizard: {
    ...
    step4: {
      title: "Haulier Selection",
      subtitle: "Choose a haulier for your request.",
      filterCity: "City",
      filterPort: "Port",
      ...
      selectedSeafreights: "Selected Seafreights",
      requestSent: "Your request has been sent!",
      basket: "Basket",
      offerId: "Offer ID: {id}"
    },
    step5: {
      title: "Seafreight Selection",
      subtitle: "Choose seafreight offers for your request.",
      selectedHaulage: "Selected haulage",
      haulierName: "Haulier",
      unitTariff: "Tariff",
      loadingCity: "Loading city",
      ...
      select: "Select",
      deselect: "Deselect",
      baseFreightLabel: "Base freight",
      totalLabel: "Total",
      validUntil: "Valid until",
      transitLabel: "Transit (days)",
      frequencyLabel: "Frequency",
      quantity: "Quantity",
      searchSeafreightPlaceholder: "Search for a maritime offer...",
      totalTEU: "Total TEU selected",
      selectedContainers: "Selected containers",
      details: "Details",
      close: "Close",
      selectThisOffer: "Select this offer"
