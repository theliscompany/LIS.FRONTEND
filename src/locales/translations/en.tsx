export const en = {
  ...
  priceFieldsEmpty: "The fields departure date, containers and destination port cannot be empty, fill them.",
  ...
  requestCreatedAssigned: "Your request has been created and assigned with success.",
  fieldsEmpty: "One or many fields are empty, please verify the form.",
