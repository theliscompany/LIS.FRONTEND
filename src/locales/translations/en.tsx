export const en = {
  ...
  requestWizard: {
    ...
    step4: {
      title: "Select a haulage offer",
      subtitle: "Choose the best haulage offer for your shipment.",
      filterCity: "City",
      filterPort: "Port",
    ...
    step5: {
      title: "Select a seafreight offer",
      selectedHaulage: "Selected haulage",
      haulierName: "Haulier",
      unitTariff: "Tariff",
      freeTime: "Free time",
      ...
      selected: "Selected",
      select: "Select",
      noOffers: "No seafreight offers available.",
      requestPrice: "Request a price",
      requestSent: "Your request has been sent.",
      previous: "Previous",
      next: "Next",
    ...
    step6: {
      ...
      departurePort: "Departure port",
      destinationPort: "Destination port",
      title: "Select miscellaneous services",
  ...
  wizard: {
    ...
    saveOption: "Option saved successfully.",
