		...
		if (context) {
			...
			if (data?.status === 200) {
				...
				<div style="font-family: Verdana; padding-top: 60px;">
					<a href="${"http://localhost:3000/acceptOffer/"+id}" style="display:inline-block;background-color:#008089;color:#fff;padding:10px 20px;text-decoration:none" target="_blank">Accept the offer</a>
					<a href="${"http://localhost:3000/refuseOffer/"+id}" style="display:inline-block;background-color:#F2F2F2;color:#008089;padding:10px 20px;text-decoration:none" target="_blank">Refuse the offer</a>
