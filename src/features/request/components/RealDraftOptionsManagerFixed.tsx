...
// 🆕 MIGRATION : Import du nouveau hook migré corrigé
import { useRealDraftOptionsManagerMigratedFixed, type DraftOptionFixed } from '../hooks/useRealDraftOptionsManagerMigratedFixed';
// Fallback vers l'ancien hook si nécessaire
...
const RealDraftOptionsManagerFixed: React.FC<RealDraftOptionsManagerFixedProps> = ({
  ...
  // 🆕 MIGRATION : Utilisation du nouveau hook migré corrigé
  const {
    options,
    selectedOptionId,
    isLoadingOptions,
    ...
    draftQuote: draftQuote as any, // Cast temporaire pour la compatibilité
